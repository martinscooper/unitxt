...
from .formats import ChatAPIFormat, SystemFormat
...
class EvalAssistLLMAsJudgePairwise(BulkInstanceMetric):
    ...
    def compute(
        ...
        format = (
            ChatAPIFormat()
            if self.model_family == ModelFamilyEnum.GPT
            else SystemFormat()
        )
        ...
        if self.evaluator_name == EvaluatorNameEnum.PROMETHEUS:
            ...
            option_selection_instances = [
                ...
                for assessment_prompt, assessment_output, option_pair in zip(
                    assessment_prompts, assessment_outputs, option_pairs
                )
            ]
            ...
            summarization_instances = [
                ...
                for assessment_output_instance in assessment_outputs_dataset[
            ...
            option_selection_instances = [
                ...
                for assessment_prompt, assessment_output, choose_response_instruction, option_pair in zip(
                    assessment_prompts,
                    assessment_outputs,
                    choose_response_instructions,
                    option_pairs,
        ...
        if (
            ...
            selections = [
                selection.split(" ")[-1] for selection in option_selection_outputs
            ]
            ...
            selections = [
                self._parse_completion(text_completion, option_pair)
                for text_completion, option_pair in zip(
                    option_selection_outputs, option_pairs
                )
            ]
